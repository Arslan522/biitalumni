...
export default function SearchedprofileScreen({ navigation, route }) {
    ...
    async function educationView() {
       // let arid=await AsyncStorage.getItem("aridnum")
        let response = await fetch
            (global.apiurl + 'student/geteducationwithregnumber?arid=' +newdataa.aridno )
    ...
    async function timelineView() {
        ...
        // return json.email
        setData(json);
        console.log("..........ProfileScreen............", global.aridnumber)
    ...
    return (
        <ScrollView>
            <View>
                ...
                <Image style={styles.bgimg2} source={{ uri: global.imageUrl + `${newdataa.image}` }} />
                <Text style={{
                    bottom: 120,
                    fontSize: 18,
                    left: 100,
                    ...
                    {newdataa.fname} {newdataa.lname}</Text>
                        ...
                        renderItem={({ item }) => {
                            return (
                                <View style={styles.flatListcontainer}>
                                    ...
                                    {/* <Image style={{ height: 160, width: 130, borderRadius: 20, marginTop: 5 }}
                  source={{ uri: global.imageUrl + `${item.image}` }} /> */}
                                    <Text style={styles.flatListtext}>{newdataa.skills}{'\n'}
                                    </Text>
                                </View>
