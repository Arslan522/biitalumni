...
global.profileimage = json[0].image;
  ...
  return (<ScrollView>
        ...
        <Image style={styles.bgimg2} source={{ uri: global.imageUrl + `${global.profileimage}` }} />
        <Text style={{
          bottom: 120,
          fontSize: 18,
          left: 100,
          ...
          {global.profilefname} {global.profilelname}</Text>
            ...
            renderItem={({ item }) => {
              return (
                <View style={styles.flatListcontainer}>
                  ...
                  {/* <Image style={{ height: 160, width: 130, borderRadius: 20, marginTop: 5 }}
                  source={{ uri: global.imageUrl + `${item.image}` }} /> */}
                  <Text style={styles.flatListtext}>{item.skills}{'\n'}
                  </Text>
                </View>
